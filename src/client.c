...
int calipso_client_init(calipso_client_t *client)
{
    //client->csocket = 0;
...
void calipso_client_unalloc(calipso_client_t *client)
{
    TRACE("@client %d\n", client->csocket);
    //client->csocket = -1;
...
int calipso_client_set_pipeline(calipso_client_t *client, queue_t *pipeline)
{
    return ((client->pipeline = pipeline) != NULL);
}

int calipso_client_set_pool(calipso_client_t *client, calipso_pool_t *pool)
{
    return ((client->pool = pool) != NULL);
}

int calipso_client_set_socket(calipso_client_t *client, int csocket)
{
    return ((client->csocket = csocket));
}

int calipso_client_sent_data(calipso_client_t *client)
{
    int nbytes;
...
int calipso_client_shutdown(calipso_client_t *client)
{
...
int calipso_client_handle_keep_alive(calipso_client_t *client)
{
...
int calipso_client_disconnect(calipso_client_t *client)
{
    calipso_socket_t *listener = calipso_client_get_listener(client);
...
int calipso_client_connection_error(calipso_client_t *client)
{
...
int calipso_client_set_request(calipso_client_t *client,
                               calipso_request_t *request)
{
    return ((client->request = request) != NULL);
}

int calipso_client_get_socket(calipso_client_t *client)
{
...
int calipso_client_set_listener(calipso_client_t *client,
                                calipso_socket_t *listener)
{
    return ((client->listener = listener) != NULL);
}

int calipso_client_set_server(calipso_client_t *client,
                              calipso_server_t *server)
{
    return ((client->server = server) != NULL);
}

int calipso_client_set_info(calipso_client_t *client, struct sockaddr_in *info)
{
    return ((client->info = info) != NULL);
}

int calipso_client_set_config(calipso_client_t *client,
...
int calipso_client_set_connect_time(calipso_client_t *client,
                                    time_t connect_time)
{
    return ((client->connect_time = connect_time) != 0);
}

time_t calipso_client_get_connect_time(calipso_client_t *client)
{
